<template>
  <div class="fixed top-6 left-0 w-full z-50 px-4">
    <nav class="max-w-5xl mx-auto bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden">
